		...
		try (Scanner sc = new Scanner(System.in)) {
			do {
				...
				case 4:
					...
					break;
				case 5:
					String emailId = InputUtil.acceptOwnerEmailIdToOperate(sc);
					String mobileNumber = InputUtil.acceptOwnerMobileNumberToOperate(sc);
					ownerDTO = ownerService.findOwner(emailId,mobileNumber);
					System.out.println("Owner has been fetched successfully.");
					System.out.println(ownerDTO);
					break;
				default:
